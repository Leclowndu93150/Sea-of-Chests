...
public class ModNetworking {
    ...
    public static void register() {
        SimpleChannel net = NetworkRegistry.ChannelBuilder
                .named(new ResourceLocation(SeaOfChests.MODID, "messages"))
        ...
        net.messageBuilder(StartUnlockingPacket.class, id(), NetworkDirection.PLAY_TO_SERVER)
                .decoder(StartUnlockingPacket::new)
                .encoder(StartUnlockingPacket::toBytes)
